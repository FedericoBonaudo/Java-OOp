...
public class CacciatoreTaglie extends Nemico {
    ...
    public CacciatoreTaglie(String classe, int forza, int resistenza, int puntiVita, Arma arma) {
    ...
    public void attacca(Personaggio personaggio){
        if(arma == null){
            System.out.println("Il cacciatore di taglie non ha un'arma!");
            return;
        }
        ...
        if(dannoEffettivo > 0){
            ...
            System.out.println("Il cacciatore di taglie ti attacca con " + arma.getNome() + ". Subisci " + dannoEffettivo + " danni.");
        } else {
            System.out.println("Il cacciatore di taglie vacilla e non riesce a colpirti, non perdi nessun punto vita.");
        }
    }
    ...
    public void parata(Personaggio personaggio){
        ...
        if(difesaEffettiva >= personaggio.getAttacco()){
            System.out.println("Il cacciatore para con efficacia il tuo colpo! Non perde punti vita");
        } else {
            System.out.println("Il cacciatore non riesce a parare del tutto il colpo e subisce " + personaggio.getAttacco() + " danni.");
        }
    }
